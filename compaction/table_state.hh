...
public:
    ...
    virtual std::unordered_set<sstables::shared_sstable> ttt_expired_sstables(const std::vector<sstables::shared_sstable>& sstables, gc_clock::time_point compaction_time) const = 0;
